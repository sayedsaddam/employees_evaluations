...
class Chws_evaluations extends CI_Controller
{
    ...
    public function export_excel(){
        ...
        foreach ($evalData as $val){
            ...
            $sheet->setCellValue('M' . $rows, $val['b4_record']);
            $sheet->setCellValue('N' . $rows, $val['b5_record']);
            $sheet->setCellValue('O' . $rows, $val['b6_record']);
            $sheet->setCellValue('P' . $rows, $val['c1_record']);
            $sheet->setCellValue('Q' . $rows, $val['c2_record']);
            $sheet->setCellValue('R' . $rows, $val['c3_record']);
            $sheet->setCellValue('S' . $rows, $val['c4_record']);
            $sheet->setCellValue('T' . $rows, $val['c5_record']);
