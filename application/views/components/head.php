  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li>
          <a href="<?php // echo base_url('performance_evaluation/tcsp_evaluation'); ?>">UCO's Evaluation</a>
        </li>
        <li>
          <a href="<?php // echo base_url('performance_evaluation/tcsp_evaluation'); ?>">DHCSO's Evaluation</a>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
